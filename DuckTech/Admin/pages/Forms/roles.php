...
<script src="js/rolesApp.js"></script>
...
<label for="rol_nombre">Nombre</label><input type="text" class="form-control" name="rol_nombre" id="rol_nombre" placeholder="Capturar Nombre" ng-model="rol_nombre">
...
<form >
<tr ng-repeat="item in roles.roles | filter:test">
