...
<script src="js/categoriaApp.js"></script>
...
<label for="cate_nombre">Nombre</label><input type="text" class="form-control" name="cate_nombre" id="cate_nombre" placeholder="Capturar cate_nombre" ng-model="cate_nombre">
<label for="cate_Activo"><input type="checkbox"  name="cate_Activo" id="cate_Activo" placeholder="Capturar cate_Activo" ng-model="cate_Activo">Activo</label>
...
<form >
<tr ng-repeat="item in categoria.categoria | filter:test">

<td>{{item.cate_nombre}}</td>
<td>{{item.cate_Activo}}</td>
