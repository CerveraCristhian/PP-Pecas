...
<html ng-app="clientesApp" ng-controller="clientesController">
<head>
  <meta charset="utf-8">
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
         <h3 class="box-title"><center>clientes</center></h3>
...
<label for="clie_nombre">clie_nombre</label><input type="text" class="form-control" name="clie_nombre" id="clie_nombre" placeholder="Capturar clie_nombre" ng-model="clie_nombre">
<label for="clie_amaterno">clie_amaterno</label><input type="text" class="form-control" name="clie_amaterno" id="clie_amaterno" placeholder="Capturar clie_amaterno" ng-model="clie_amaterno">
<label for="clie_apaterno">clie_apaterno</label><input type="text" class="form-control" name="clie_apaterno" id="clie_apaterno" placeholder="Capturar clie_apaterno" ng-model="clie_apaterno">
<label for="clie_email">clie_email</label><input type="text" class="form-control" name="clie_email" id="clie_email" placeholder="Capturar clie_email" ng-model="clie_email">
<label for="clie_emailrazon">clie_emailrazon</label><input type="text" class="form-control" name="clie_emailrazon" id="clie_emailrazon" placeholder="Capturar clie_emailrazon" ng-model="clie_emailrazon">
<label for="clie_fechaingresosistema">clie_fechaingresosistema</label><input type="text" class="form-control" name="clie_fechaingresosistema" id="clie_fechaingresosistema" placeholder="Capturar clie_fechaingresosistema" ng-model="clie_fechaingresosistema">
<label for="clie_razonsocial">clie_razonsocial</label><input type="text" class="form-control" name="clie_razonsocial" id="clie_razonsocial" placeholder="Capturar clie_razonsocial" ng-model="clie_razonsocial">
<label for="clie_observaciones">clie_observaciones</label><input type="text" class="form-control" name="clie_observaciones" id="clie_observaciones" placeholder="Capturar clie_observaciones" ng-model="clie_observaciones">
<label for="clie_rfc">clie_rfc</label><input type="text" class="form-control" name="clie_rfc" id="clie_rfc" placeholder="Capturar clie_rfc" ng-model="clie_rfc">
<label for="clie_fax">clie_fax</label><input type="text" class="form-control" name="clie_fax" id="clie_fax" placeholder="Capturar clie_fax" ng-model="clie_fax">
<label for="clie_clienteid">clie_clienteid</label><input type="text" class="form-control" name="clie_clienteid" id="clie_clienteid" placeholder="Capturar clie_clienteid" ng-model="clie_clienteid">
...
<th>clie_apaterno</th>
<th>clie_email</th>
<th>clie_emailrazon</th>
<th>clie_fechaingresosistema</th>
<th>clie_razonsocial</th>
<th>clie_observaciones</th>
<th>clie_rfc</th>
<th>clie_fax</th>
<th>clie_clienteid</th>
...
<form >
<tr ng-repeat="item in clientes.clientes | filter:test">

<td>{{item.clie_nombre}}</td>
<td>{{item.clie_amaterno}}</td>
<td>{{item.clie_apaterno}}</td>
<td>{{item.clie_email}}</td>
<td>{{item.clie_emailrazon}}</td>
<td>{{item.clie_fechaingresosistema}}</td>
<td>{{item.clie_razonsocial}}</td>
<td>{{item.clie_observaciones}}</td>
<td>{{item.clie_rfc}}</td>
<td>{{item.clie_fax}}</td>
<td>{{item.clie_clienteid}}</td>
