...
<script src="js/rolpermisoApp.js"></script>
...
<select id="cmbRol" class="form-control"  ng-model="Roles_rol_rolid" ng-options="rol.rol_nombre for rol in roles.roles">
                          </select>
<label for="Permisos_perm_permisoid">Permisos</label>
<select id="cmbRol" class="form-control"  ng-model="Permisos_perm_permisoid" ng-options="permisos.perm_nombre for permisos in permisos.permisos">
                          </select>
...
<form >
<tr ng-repeat="item in rolpermiso.rolpermiso | filter:test">
