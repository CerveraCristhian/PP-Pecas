...
<html ng-app="direccionproveedorApp" ng-controller="direccionproveedorController">
<head>
  <meta charset="utf-8">
...
<script src="js/direccionproveedorApp.js"></script>
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
         <h3 class="box-title"><center>direccionproveedor</center></h3>
...
<label for="direprove_calle">direprove_calle</label><input type="text" class="form-control" name="direprove_calle" id="direprove_calle" placeholder="Capturar direprove_calle" ng-model="direprove_calle">
<label for="direprove_numero">direprove_numero</label><input type="text" class="form-control" name="direprove_numero" id="direprove_numero" placeholder="Capturar direprove_numero" ng-model="direprove_numero">
<label for="direprove_colonia">direprove_colonia</label><input type="text" class="form-control" name="direprove_colonia" id="direprove_colonia" placeholder="Capturar direprove_colonia" ng-model="direprove_colonia">
<label for="direprove_numeroexterior">direprove_numeroexterior</label><input type="text" class="form-control" name="direprove_numeroexterior" id="direprove_numeroexterior" placeholder="Capturar direprove_numeroexterior" ng-model="direprove_numeroexterior">
<label for="Proveedor_prov_proveedorid">Proveedor_prov_proveedorid</label><input type="text" class="form-control" name="Proveedor_prov_proveedorid" id="Proveedor_prov_proveedorid" placeholder="Capturar Proveedor_prov_proveedorid" ng-model="Proveedor_prov_proveedorid">
<label for="direprove_direccionproveedorid">direprove_direccionproveedorid</label><input type="text" class="form-control" name="direprove_direccionproveedorid" id="direprove_direccionproveedorid" placeholder="Capturar direprove_direccionproveedorid" ng-model="direprove_direccionproveedorid">
...
<th>direprove_calle</th>
<th>direprove_numero</th>
<th>direprove_colonia</th>
<th>direprove_numeroexterior</th>
<th>Proveedor_prov_proveedorid</th>
<th>direprove_direccionproveedorid</th>
...
<form >
<tr ng-repeat="item in direccionproveedor.direccionproveedor | filter:test">

<td>{{item.direprove_calle}}</td>
<td>{{item.direprove_numero}}</td>
<td>{{item.direprove_colonia}}</td>
<td>{{item.direprove_numeroexterior}}</td>
<td>{{item.Proveedor_prov_proveedorid}}</td>
<td>{{item.direprove_direccionproveedorid}}</td>
