...
<html ng-app="modulosApp" ng-controller="modulosController">
<head>
  <meta charset="utf-8">
...
<script src="js/modulosApp.js"></script>
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
         <h3 class="box-title"><center>modulos</center></h3>
...
<label for="modu_nombre">modu_nombre</label><input type="text" class="form-control" name="modu_nombre" id="modu_nombre" placeholder="Capturar modu_nombre" ng-model="modu_nombre">
<label for="TipoModulo_timo_tipomoduloid">TipoModulo_timo_tipomoduloid</label><input type="text" class="form-control" name="TipoModulo_timo_tipomoduloid" id="TipoModulo_timo_tipomoduloid" placeholder="Capturar TipoModulo_timo_tipomoduloid" ng-model="TipoModulo_timo_tipomoduloid">
...
<th>modu_nombre</th>
<th>TipoModulo_timo_tipomoduloid</th>
...
<form >
<tr ng-repeat="item in modulos.modulos | filter:test">

<td>{{item.modu_nombre}}</td>
<td>{{item.TipoModulo_timo_tipomoduloid}}</td>
