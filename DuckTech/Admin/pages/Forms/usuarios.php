...
<script src="js/usuariosApp.js"></script>
...
<label for="user_name">Nombre de Usuario</label><input type="text" class="form-control" name="user_name" id="user_name" placeholder="Capturar user_name" ng-model="user_name">
<label for="user_password">Password</label><input type="password" class="form-control" name="user_password" id="user_password" placeholder="Capturar Contraseña" ng-model="user_password">
