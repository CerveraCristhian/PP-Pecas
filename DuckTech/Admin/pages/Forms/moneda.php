...
<script src="js/monedaApp.js"></script>
...
<label for="mone_nombre">Nombre</label><input type="text" class="form-control" name="mone_nombre" id="mone_nombre" placeholder="Capturar mone_nombre" ng-model="mone_nombre">
<label for="mone_simbolo">Simbolo</label><input type="text" class="form-control" name="mone_simbolo" id="mone_simbolo" placeholder="Capturar mone_simbolo" ng-model="mone_simbolo">
...
<form >
<tr ng-repeat="item in moneda.moneda | filter:test">

<td>{{item.mone_nombre}}</td>
<td>{{item.mone_simbolo}}</td>
