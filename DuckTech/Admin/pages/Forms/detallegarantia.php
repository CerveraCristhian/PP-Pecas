...
<html ng-app="detallegarantiaApp" ng-controller="detallegarantiaController">
<head>
  <meta charset="utf-8">
...
<script src="js/detallegarantiaApp.js"></script>
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
         <h3 class="box-title"><center>detallegarantia</center></h3>
...
<label for="dega_nombre">dega_nombre</label><input type="text" class="form-control" name="dega_nombre" id="dega_nombre" placeholder="Capturar dega_nombre" ng-model="dega_nombre">
<label for="Garantia_gara_garantiaid">Garantia_gara_garantiaid</label><input type="text" class="form-control" name="Garantia_gara_garantiaid" id="Garantia_gara_garantiaid" placeholder="Capturar Garantia_gara_garantiaid" ng-model="Garantia_gara_garantiaid">
<label for="dega_detallegarantiaid">dega_detallegarantiaid</label><input type="text" class="form-control" name="dega_detallegarantiaid" id="dega_detallegarantiaid" placeholder="Capturar dega_detallegarantiaid" ng-model="dega_detallegarantiaid">
...
<th>dega_nombre</th>
<th>Garantia_gara_garantiaid</th>
<th>dega_detallegarantiaid</th>
...
<form >
<tr ng-repeat="item in detallegarantia.detallegarantia | filter:test">

<td>{{item.dega_nombre}}</td>
<td>{{item.Garantia_gara_garantiaid}}</td>
<td>{{item.dega_detallegarantiaid}}</td>
