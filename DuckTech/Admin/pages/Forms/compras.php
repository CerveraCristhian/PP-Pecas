...
<html ng-app="comprasApp" ng-controller="comprasController">
<head>
  <meta charset="utf-8">
...
<script src="js/comprasApp.js"></script>
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
         <h3 class="box-title"><center>compras</center></h3>
...
<label for="comp_fecha">comp_fecha</label><input type="text" class="form-control" name="comp_fecha" id="comp_fecha" placeholder="Capturar comp_fecha" ng-model="comp_fecha">
<label for="comp_subtotal">comp_subtotal</label><input type="text" class="form-control" name="comp_subtotal" id="comp_subtotal" placeholder="Capturar comp_subtotal" ng-model="comp_subtotal">
<label for="comp_iva">comp_iva</label><input type="text" class="form-control" name="comp_iva" id="comp_iva" placeholder="Capturar comp_iva" ng-model="comp_iva">
<label for="comp_total">comp_total</label><input type="text" class="form-control" name="comp_total" id="comp_total" placeholder="Capturar comp_total" ng-model="comp_total">
<label for="comp_compraid">comp_compraid</label><input type="text" class="form-control" name="comp_compraid" id="comp_compraid" placeholder="Capturar comp_compraid" ng-model="comp_compraid">
...
<form >
<tr ng-repeat="item in compras.compras | filter:test">

<td>{{item.comp_fecha}}</td>
<td>{{item.comp_subtotal}}</td>
<td>{{item.comp_iva}}</td>
<td>{{item.comp_total}}</td>
<td>{{item.comp_compraid}}</td>
