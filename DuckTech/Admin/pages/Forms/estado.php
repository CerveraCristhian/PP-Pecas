...
<html ng-app="estadoApp" ng-controller="estadoController">
<head>
  <meta charset="utf-8">
...
<script src="js/estadoApp.js"></script>
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
         <h3 class="box-title"><center>estado</center></h3>
...
<label for="esta_nombre">esta_nombre</label><input type="text" class="form-control" name="esta_nombre" id="esta_nombre" placeholder="Capturar esta_nombre" ng-model="esta_nombre">
<label for="Paises_pais_paisid">Paises_pais_paisid</label><input type="text" class="form-control" name="Paises_pais_paisid" id="Paises_pais_paisid" placeholder="Capturar Paises_pais_paisid" ng-model="Paises_pais_paisid">
<label for="esta_estadoid">esta_estadoid</label><input type="text" class="form-control" name="esta_estadoid" id="esta_estadoid" placeholder="Capturar esta_estadoid" ng-model="esta_estadoid">
...
<form >
<tr ng-repeat="item in estado.estado | filter:test">

<td>{{item.esta_nombre}}</td>
<td>{{item.Paises_pais_paisid}}</td>
<td>{{item.esta_estadoid}}</td>
