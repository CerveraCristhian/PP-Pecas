...
<script src="js/contenidowebApp.js"></script>
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
         <h3 class="box-title"><center>contenidoweb</center></h3>
...
<label for="contw_clave">contw_clave</label><input type="text" class="form-control" name="contw_clave" id="contw_clave" placeholder="Capturar contw_clave" ng-model="contw_clave">
...
<th>contw_descripcion</th>
<th>contw_descripcioningles</th>
<th>contw_clave</th>
...
<td>{{item.contw_descripcion}}</td>
<td>{{item.contw_descripcioningles}}</td>
