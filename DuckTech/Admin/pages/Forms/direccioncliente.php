...
<html ng-app="direccionclienteApp" ng-controller="direccionclienteController">
<head>
  <meta charset="utf-8">
...
<script src="js/direccionclienteApp.js"></script>
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
         <h3 class="box-title"><center>direccioncliente</center></h3>
...
<label for="direclie_calle">direclie_calle</label><input type="text" class="form-control" name="direclie_calle" id="direclie_calle" placeholder="Capturar direclie_calle" ng-model="direclie_calle">
<label for="direclie_numero">direclie_numero</label><input type="text" class="form-control" name="direclie_numero" id="direclie_numero" placeholder="Capturar direclie_numero" ng-model="direclie_numero">
<label for="direclie_colonia">direclie_colonia</label><input type="text" class="form-control" name="direclie_colonia" id="direclie_colonia" placeholder="Capturar direclie_colonia" ng-model="direclie_colonia">
<label for="direclie_numeroexterior">direclie_numeroexterior</label><input type="text" class="form-control" name="direclie_numeroexterior" id="direclie_numeroexterior" placeholder="Capturar direclie_numeroexterior" ng-model="direclie_numeroexterior">
<label for="Clientes_clie_clienteid">Clientes_clie_clienteid</label><input type="text" class="form-control" name="Clientes_clie_clienteid" id="Clientes_clie_clienteid" placeholder="Capturar Clientes_clie_clienteid" ng-model="Clientes_clie_clienteid">
<label for="direclie_direccionclienteid">direclie_direccionclienteid</label><input type="text" class="form-control" name="direclie_direccionclienteid" id="direclie_direccionclienteid" placeholder="Capturar direclie_direccionclienteid" ng-model="direclie_direccionclienteid">
...
<th>direclie_calle</th>
<th>direclie_numero</th>
<th>direclie_colonia</th>
<th>direclie_numeroexterior</th>
<th>Clientes_clie_clienteid</th>
<th>direclie_direccionclienteid</th>
...
<form >
<tr ng-repeat="item in direccioncliente.direccioncliente | filter:test">

<td>{{item.direclie_calle}}</td>
<td>{{item.direclie_numero}}</td>
<td>{{item.direclie_colonia}}</td>
<td>{{item.direclie_numeroexterior}}</td>
<td>{{item.Clientes_clie_clienteid}}</td>
<td>{{item.direclie_direccionclienteid}}</td>
