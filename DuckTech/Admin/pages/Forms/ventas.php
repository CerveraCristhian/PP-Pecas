...
<html ng-app="ventasApp" ng-controller="ventasController">
<head>
  <meta charset="utf-8">
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
         <h3 class="box-title"><center>ventas</center></h3>
...
<label for="vent_fecha">vent_fecha</label><input type="text" class="form-control" name="vent_fecha" id="vent_fecha" placeholder="Capturar vent_fecha" ng-model="vent_fecha">
<label for="vent_subtotal">vent_subtotal</label><input type="text" class="form-control" name="vent_subtotal" id="vent_subtotal" placeholder="Capturar vent_subtotal" ng-model="vent_subtotal">
<label for="vent_iva">vent_iva</label><input type="text" class="form-control" name="vent_iva" id="vent_iva" placeholder="Capturar vent_iva" ng-model="vent_iva">
<label for="vent_total">vent_total</label><input type="text" class="form-control" name="vent_total" id="vent_total" placeholder="Capturar vent_total" ng-model="vent_total">
<label for="vent_ventaid">vent_ventaid</label><input type="text" class="form-control" name="vent_ventaid" id="vent_ventaid" placeholder="Capturar vent_ventaid" ng-model="vent_ventaid">
...
<form >
<tr ng-repeat="item in ventas.ventas | filter:test">

<td>{{item.vent_fecha}}</td>
<td>{{item.vent_subtotal}}</td>
<td>{{item.vent_iva}}</td>
<td>{{item.vent_total}}</td>
<td>{{item.vent_ventaid}}</td>
