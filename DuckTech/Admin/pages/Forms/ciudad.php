...
<html ng-app="ciudadApp" ng-controller="ciudadController">
<head>
  <meta charset="utf-8">
...
<script src="js/ciudadApp.js"></script>
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
         <h3 class="box-title"><center>ciudad</center></h3>
...
<label for="ciud_nombre">ciud_nombre</label><input type="text" class="form-control" name="ciud_nombre" id="ciud_nombre" placeholder="Capturar ciud_nombre" ng-model="ciud_nombre">
<label for="Estado_esta_estadoid">Estado_esta_estadoid</label><input type="text" class="form-control" name="Estado_esta_estadoid" id="Estado_esta_estadoid" placeholder="Capturar Estado_esta_estadoid" ng-model="Estado_esta_estadoid">
<label for="ciud_ciudadid">ciud_ciudadid</label><input type="text" class="form-control" name="ciud_ciudadid" id="ciud_ciudadid" placeholder="Capturar ciud_ciudadid" ng-model="ciud_ciudadid">
...
<form >
<tr ng-repeat="item in ciudad.ciudad | filter:test">

<td>{{item.ciud_nombre}}</td>
<td>{{item.Estado_esta_estadoid}}</td>
<td>{{item.ciud_ciudadid}}</td>
