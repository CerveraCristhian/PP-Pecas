<!DOCTYPE html>
<html ng-app="medidaApp" ng-controller="medidaController">
<head>
  <meta charset="utf-8">
...
<script src="js/medidaApp.js"></script>
       ...
       <li>
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="medida.html"><i class="fa fa-circle-o"></i> Medida</a></li>
            ...
            <li ><a href="categoria.html"><i class="fa fa-circle-o"></i> Categoria</a></li>
...
<label for="medi_nombre">Nombre</label><input type="text" class="form-control" name="medi_nombre" id="medi_nombre" placeholder="Capturar medi_nombre" ng-model="medi_nombre">
<label for="medi_activo">Activo</label><input type="text" class="form-control" name="medi_activo" id="medi_activo" placeholder="Capturar medi_activo" ng-model="medi_activo">
...
<form >
<tr ng-repeat="item in medida.medida | filter:test">

<td>{{item.medi_nombre}}</td>
<td>{{item.medi_activo}}</td>
