...
<html ng-app="calidadApp" ng-controller="calidadController">
  <head>
    <meta charset="utf-8">
    ...
    <script src="js/calidadApp.js"></script>
          ...
          <form role="form" name="formulario">
            <div class="box-body">
              <div class="form-group">
                <label for="cali_nombre">Nombre</label><input type="text" class="form-control" name="cali_nombre" id="cali_nombre" placeholder="Capturar cali_nombre" ng-model="cali_nombre">
              </div>
              <div class="box-footer">
                <button class="btn btn-primary" ng-click="Guardar()">Guardar</button>
              </div>
            </form>
            Buscar: <input type="te" ng-model="test">
            <div class="box-body table-responsive no-padding">
              <table id="example" class="table table-striped"  cellspacing="0" width="100%">
                ...
                <tbody>
                  <form >
                    <tr ng-repeat="item in calidad.calidad | filter:test">
