...
<html ng-app="permisosApp" ng-controller="permisosController">
<head>
  <meta charset="utf-8">
...
<script src="js/permisosApp.js"></script>
...
<label for="perm_nombre">Nombre</label><input type="text" class="form-control" name="perm_nombre" id="perm_nombre" placeholder="Capturar perm_nombre" ng-model="perm_nombre">
...
<form >
<tr ng-repeat="item in permisos.permisos | filter:test">
