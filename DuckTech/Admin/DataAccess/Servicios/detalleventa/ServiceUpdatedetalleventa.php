...
$metas = Meta::Updatedetalleventa($detve_cantidad, $detve_precio, $detve_tipocambio, $Ventas_vent_ventaid, $Producto_prod_productoid, $Producto_SubCategoria_subc_subcategoriaid, $Calidad_cali_calidadid, $DetalleGarantia_dega_detallegarantiaid, $detve_detalleventaid);
if ($metas) {
