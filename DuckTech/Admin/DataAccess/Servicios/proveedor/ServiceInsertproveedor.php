...
$metas = Meta::Insertproveedor($prov_nombre, $prov_amaterno, $prov_apaterno, $prov_email, $prov_emailrazon, $prov_fechaingresosistema, $prov_razonsocial, $prov_observaciones, $prov_rfc, $prov_fax);
if ($metas) {
